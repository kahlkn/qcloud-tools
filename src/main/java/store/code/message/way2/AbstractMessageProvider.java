...
import store.code.message.way2.sender.ConsoleSender;
import store.code.message.way2.sender.LogSender;
import store.code.message.way2.sender.MessageSender;
...
import static store.code.message.way2.MessageType.UNKNOWN;
...
public abstract class AbstractMessageProvider implements MessageProvider {
    ...
    public AbstractMessageProvider() {
        ...
        registerSender(new LogSender(UNKNOWN));
