...
public class RedisUserAutoConfiguration {
    ...
    public RedisUserAutoConfiguration(RedisTemplate<String, String> stringStrRedisTemplate,
                                      RedisTemplate<String, Object> stringObjRedisTemplate,
                                      UserProperties userProperties) {

        this(stringStrRedisTemplate, stringObjRedisTemplate, userProperties, null, null);
    }
    ...
    public RedisUserAutoConfiguration(RedisTemplate<String, String> stringStrRedisTemplate,
        ...
        this(stringStrRedisTemplate, stringObjRedisTemplate, userProperties, userLoader, null);
    }
    ...
    public RedisUserAutoConfiguration(RedisTemplate<String, String> stringStrRedisTemplate,
        ...
        this.tokenManager = new RedisTokenManager(stringStrRedisTemplate, tokenExpirationTime);
        this.userManager = new RedisUserManager(stringObjRedisTemplate, userExpirationTime, userLoader);
        this.permissionManager = new RedisPermissionManager(stringStrRedisTemplate,
