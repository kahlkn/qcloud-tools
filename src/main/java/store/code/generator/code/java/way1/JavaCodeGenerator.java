...
import store.code.jdbc.way1.ColumnMeta;
import store.code.jdbc.way1.DatabaseClient;
import store.code.jdbc.way1.TableMeta;
...
import static kunlun.common.constant.TimePatterns.Y4MD2MI_HMS2CO_S3;
...
public class JavaCodeGenerator implements Serializable {
    ...
    public JavaCodeGenerator() {
        this.addAttribute("author", "kunlun-plus");
